...
MpiMcastGroupComm::MpiMcastGroupComm(tensorrt_llm::mpi::MpiComm comm)
    : mComm(std::move(comm))
{
}
...
int32_t MpiMcastGroupComm::allreduceInt32Min(int32_t value)
{
    int32_t result{value};
    mComm.allreduce(&value, &result, 1, mpi::MpiType::kINT32, mpi::MpiOp::MIN);
    return result;
}

int32_t MpiMcastGroupComm::allreduceInt32Max(int32_t value)
{
    int32_t result{value};
    mComm.allreduce(&value, &result, 1, mpi::MpiType::kINT32, mpi::MpiOp::MAX);
    return result;
}
